...
public class OneCameraImpl extends AbstractOneCamera {
    ...
    private static class InFlightCapture {
        ...
        public InFlightCapture(PictureCallback callback,
     ...
     * yet.
     */
    private final LinkedList<InFlightCapture> mCallbackQueue = new LinkedList<InFlightCapture>();
    ...
    ImageReader.OnImageAvailableListener mJpegImageListener =
            new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    final InFlightCapture capture = mCallbackQueue.remove();
                    capture.callback.onPictureTaken(imageBytes, capture.session);
                }
            };
    ...
    public void takePicture(PhotoCaptureParameters params, CaptureSession session) {
        ...
        mCallbackQueue.add(new InFlightCapture(params.callback, session));
    }
