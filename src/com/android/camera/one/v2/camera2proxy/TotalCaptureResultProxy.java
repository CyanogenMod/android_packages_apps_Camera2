...
public class TotalCaptureResultProxy extends CaptureResultProxy {
    private final TotalCaptureResult mTotalCaptureResult;

    public TotalCaptureResultProxy(TotalCaptureResult totalCaptureResult) {
    ...
    public List<CaptureResultProxy> getPartialResults() {
        ...
        for (CaptureResult result : partialResults) {
            proxies.add(new CaptureResultProxy(result));
        }
        return proxies;
    }
}
