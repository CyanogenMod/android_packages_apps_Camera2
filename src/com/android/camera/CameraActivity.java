            ...
            new FilmStripView.Listener() {
                ...
                public void onCurrentDataCentered(int dataID) {
                    if (dataID != 0 && !mFilmStripView.isCameraPreview()) {
                        if (Settings.System.getInt(CameraActivity.this.getContentResolver(),		
                                    Settings.System.ACCELEROMETER_ROTATION, 0) == 0) {		
                            CameraActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED);
                            Log.i("info", "1");
                        } else {		
                            CameraActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);   
                            Log.i("info", "2");             
                        }
                        itIsCamView = false;
