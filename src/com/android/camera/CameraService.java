...
public class CameraService extends Service implements ICameraActivity, CameraAgent.CameraOpenCallback {
    ...
    private boolean mFinalShutdown;

    private boolean mRecordRequested;
    private boolean mPreviewReady;

    private static final int IDLE_DELAY = 30 * 1000;
    ...
    private static final String SHUTDOWN_FINAL = "com.android.camera2.shutdownfinal";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (SHUTDOWN.equals(action)) {
            ...
            } else if (SHUTDOWN_FINAL.equals(action)) {
                ...
                scheduleDelayedShutdown();
                // TODO: add multiple startups for recording
            }
        }
    ...
    private void scheduleDelayedShutdown() {
        if (mFinalShutdown) {
            Log.w(TAG, "shutdown already started, skipping");
            return;
        }
    ...
    private void stopRecording() {
        mMainHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (mFinalShutdown) {
                    final Intent shutdownIntent = new Intent(CameraService.this, CameraService.class);
                    shutdownIntent.setAction(SHUTDOWN_FINAL);
